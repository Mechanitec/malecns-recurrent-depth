...
Invoke-Step 'input population study' @('scripts/run_input_population_study.py','--checkpoint','results/training/v1_depth16_rate_large/readout_checkpoint.npz','--annotations','data/body-annotations-male-cns-v1.0-minconf-0.5.feather','--neurotransmitters','data/body-neurotransmitters-male-cns-v1.0.feather','--weights','data/connectome-weights-male-cns-v1.0-minconf-0.5.feather','--sensory-indices','data/chess_sensory_indices.npy','--corpus','data/chess_development_corpus_v1.csv','--manifests','data/populations_v2/manifests','--output','results/population_study','--batch-positions',$BatchPositions)
Invoke-Step 'H-BIO-1 study' @('scripts/run_h_bio_1.py','--checkpoint','results/training/v1_depth16_rate_large/readout_checkpoint.npz','--annotations','data/body-annotations-male-cns-v1.0-minconf-0.5.feather','--neurotransmitters','data/body-neurotransmitters-male-cns-v1.0.feather','--weights','data/connectome-weights-male-cns-v1.0-minconf-0.5.feather','--sensory-indices','data/chess_sensory_indices.npy','--corpus','data/chess_development_corpus_v1.csv','--manifests','data/populations_v2/manifests','--output','results/population_study','--batch-positions',$BatchPositions)
Invoke-Step 'population size scaling' @('scripts/run_population_size_scaling.py','--checkpoint','results/training/v1_depth16_rate_large/readout_checkpoint.npz','--annotations','data/body-annotations-male-cns-v1.0-minconf-0.5.feather','--neurotransmitters','data/body-neurotransmitters-male-cns-v1.0.feather','--weights','data/connectome-weights-male-cns-v1.0-minconf-0.5.feather','--sensory-indices','data/chess_sensory_indices.npy','--corpus','data/chess_development_corpus_v1.csv','--manifests','data/populations_v2/manifests','--atlas','results/population_study/malecns_region_atlas.json','--output','results/population_study','--batch-positions',$BatchPositions)
Invoke-Step 'seed robustness' @('scripts/run_seed_robustness.py','--checkpoint','results/training/v1_depth16_rate_large/readout_checkpoint.npz','--annotations','data/body-annotations-male-cns-v1.0-minconf-0.5.feather','--neurotransmitters','data/body-neurotransmitters-male-cns-v1.0.feather','--weights','data/connectome-weights-male-cns-v1.0-minconf-0.5.feather','--sensory-indices','data/chess_sensory_indices.npy','--readout-indices','data/chess_readout_indices.npy','--manifests','data/populations_v2/manifests','--corpus','data/chess_development_corpus_v1.csv','--output','results/population_study','--seeds','20','--positions-per-split','32','--batch-positions',$BatchPositions)
...
Invoke-Step 'fresh confirmation' @('scripts/run_fresh_confirmation.py','--checkpoint','results/training/v1_depth16_rate_large/readout_checkpoint.npz','--annotations','data/body-annotations-male-cns-v1.0-minconf-0.5.feather','--neurotransmitters','data/body-neurotransmitters-male-cns-v1.0.feather','--weights','data/connectome-weights-male-cns-v1.0-minconf-0.5.feather','--sensory-indices','data/chess_sensory_indices.npy','--corpus','data/chess_confirmatory_corpus_v2.csv','--manifests','data/populations_v2/manifests','--selection','results/population_study/final_selection.json','--output','results/population_study','--batch-positions',$BatchPositions)
